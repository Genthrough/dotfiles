...
- added feature [#157](https://github.com/janisdd/vscode-edit-csv/issues/157) - hide columns initially, added options
...
- fixed issue [#147](https://github.com/janisdd/vscode-edit-csv/issues/147): add feature to automatically reload data if the source csv file changes
- fixed issue [#152](https://github.com/janisdd/vscode-edit-csv/issues/152): support drag and paste like excel
  - enabled `dragToAutoFill`/`fillHandle` option
  - only supports copying same sequences `1,2,3` will copy `1,2,3` again not `4,5,6`


# 0.9.1
- fixed issue [#146](https://github.com/janisdd/vscode-edit-csv/issues/146) - doubleClickRowHandleForcedHeight was a string (package config must be a number)
- fixed issue [#144](https://github.com/janisdd/vscode-edit-csv/issues/144) - tools menu item background was the same as foreground color

# 0.9.0
- fixed annoying issue where initial scroll position was set incorrectly (when the row was in the first half)
- fixed issue [#140](https://github.com/janisdd/vscode-edit-csv/issues/140) - add feature to hide columns
- fixed issue [#31](https://github.com/janisdd/vscode-edit-csv/issues/31), [#139](https://github.com/janisdd/vscode-edit-csv/issues/139) - `ctrl+tab`, `ctrl+shift+tab`, `alt+1`, ..., `alt+9` (on linux/windows) is not longer consumed by handsontable
- fixes issue [#75](https://github.com/janisdd/vscode-edit-csv/issues/75) - watch files outside of workspace for changes
...
# 0.8.3
- merged PR [#134](https://github.com/janisdd/vscode-edit-csv/issues/134) - fix instance comparison
...
# 0.8.2
- fixed issue [#133](https://github.com/janisdd/vscode-edit-csv/issues/133) - not working in browser with `code-server`

# 0.8.1
- fixed issue [#132](https://github.com/janisdd/vscode-edit-csv/issues/132) - search hit are again highlighted when cells contain urls
- maybe fixed issue [#124](https://github.com/janisdd/vscode-edit-csv/issues/124) by - adding option to set delimiters to guess manually

# 0.8.0
- trim cells can now be undone (not for header cells)
- fixed issue [#122](https://github.com/janisdd/vscode-edit-csv/issues/122) - add option customize text color
- added feature [#130](https://github.com/janisdd/vscode-edit-csv/issues/130) - add feature resize rows
	- works the same as `doubleClickColumnHandleForcedWith` (auto resize is a bit better implemented)
- adds feature [#109](https://github.com/janisdd/vscode-edit-csv/issues/109) - open urls in browser
